...
<section class="edit-container" id="graph-{}">
        <div class="param-editor">
            ...
            <div class="data-sets-container">
                ...
                <button class="add-btn" parent="graph-{}">
...
function createNewGraph() {
    ...
    // main.innerHTML += graph_obj.replace(/\{\}/g, ngraph.toString());

    // let canvas_parent = document.getElementById(`graph-container-${ngraph}`);

    // canvas.push(new Canvas(canvas_parent, 2000, 1150, 2));
    // graphs.push(new Graph());
    // graphs[graphs.length - 1].render(canvas[graphs.length - 1].ctx);
